...
Revision ID: fc028119c603
Revises: None
Create Date: 2016-02-10 01:24:40.005803

"""

# revision identifiers, used by Alembic.
revision = 'fc028119c603'
down_revision = None
...
def upgrade():
    ...
    op.create_index(op.f('ix_articles_creat_time'), 'articles', ['creat_time'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_articles_creat_time'), table_name='articles')
